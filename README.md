...
- **AntarYatra** — a wellness platform I built end to end, journaling + mood tracking with an AI layer that reads across a bunch of Indian languages (Hindi, Tamil, Bengali, etc).
...
If something's broken or you just want to talk about ML/markets/systems stuff, reach out — contact info's on the site.
